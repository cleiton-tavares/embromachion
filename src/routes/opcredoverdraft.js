...
module.exports = ({ express, controllers }) => {
  ...
  // REGULAR ROUTES
  express.get(baseApi, (req, res) => IndexController.sigleApi(model, 'contract', req, res));
  express.get(`${baseApi}/:id`, (req, res) => IndexController.sigleApi(model, 'contractid', req, res));
  ...
  express.get(`${baseApi}/:id/id/batch`, (req, res) => IndexController.batchApi(model, 'contractid', req, res));
