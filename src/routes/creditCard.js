 ...
 */
 module.exports = ({ express, controllers }) => {
  ...
  express.get(`${baseApi}/:id/bills/:bullId/transactions/batch`, (req, res) => IndexController.sigleApi(model, 'billId_transactions', req, res));
  express.get(`${baseApi}/:id/limits/batch`, (req, res) => IndexController.batchApi(model, 'limits', req, res));
