 ...
 */
 module.exports = ({ express, controllers }) => {
    ...
    // REGULAR ROUTES
    express.get(baseApi, (req, res) => IndexController.sigleApi(model, 'contrats', req, res));
    express.get(`${baseApi}/:id`, (req, res) => IndexController.sigleApi(model, 'contractsid', req, res));
    ...
    // BATCH ROUTES
    express.get(`${baseApi}/:id/batch`, (req, res) => IndexController.batchApi(model, 'contrats', req, res));
    express.get(`${baseApi}/:id/id/batch`, (req, res) => IndexController.batchApi(model, 'contractsid', req, res));
